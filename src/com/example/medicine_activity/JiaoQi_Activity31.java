...
public class JiaoQi_Activity31 extends TabActivity{
	private String[] names = new String []
			{"治疗脚气药根治特效脚痒脚癣喷剂膏","治脚气根治特效药去除脚气药膏喷剂","子羞中药泡脚粉藏红花","脚气一绝脱皮水泡香港脚痒中药泡脚粉 "};
	private String[] descs = new String[]
			{"参考价格：¥29.9","参考价格：¥39.9","参考价格：¥29.8","参考价格：¥9.9"};
	private  int[] imageIds = new int[]
			{ R.drawable.jiaoqi1,  R.drawable.jiaoqi2,  R.drawable.jiaoqi3,  R.drawable.jiaoqi4};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_jiaoqi);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_jiaoqi_items);
//        为ListView设置Adapter
