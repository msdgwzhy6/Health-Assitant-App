...
public class BaiDianFeng_Activity32 extends TabActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_baidianfeng);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_baidianfeng_items);
//        为ListView设置Adapter
