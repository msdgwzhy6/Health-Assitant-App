...
public class BiYan_Activity50 extends TabActivity{
	private String[] names = new String []
			{"辅舒良 丙酸氟替卡松鼻喷雾剂 ","雷诺考特布地奈德鼻喷雾剂 过敏性鼻炎喷剂","紫鑫藿胆片清热通窍用于湿浊内蕴胆经郁火所致鼻炎","广雅慢性过敏性 鼻炎喷剂正品中药无激素"};
	private String[] descs = new String[]
			{"参考价格：¥69.0","参考价格：¥93.5","参考价格：¥75.0","参考价格：¥27.7"};
	private  int[] imageIds = new int[]
			{ R.drawable.baidianfeng1,  R.drawable.baidianfeng2,  R.drawable.baidianfeng3,  R.drawable.baidianfeng4};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_biyan);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_biyan_items);
//        为ListView设置Adapter
