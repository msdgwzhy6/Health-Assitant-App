...
public class YaZhouYan_Activity56 extends TabActivity{
	private String[] names = new String []
			{"正品涑爽复方丁硼乳膏牙龈炎牙周炎口腔溃疡","治疗去除白斑白癜风特效中药外用非遮盖液体防水","纯中药白斑消散液外用白班非遮盖液白癜净白癜风特效","盖百清白斑 白癜风遮盖液防水 白癜风外用"};
	private String[] descs = new String[]
			{"参考价格：¥78.0","参考价格：¥79.0","参考价格：¥98.0","参考价格：¥139.0"};
	private  int[] imageIds = new int[]
			{ R.drawable.baidianfeng1,  R.drawable.baidianfeng2,  R.drawable.baidianfeng3,  R.drawable.baidianfeng4};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_yazhouyan);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_yazhouyan_items);
//        为ListView设置Adapter
