...
public class ZhiChuang_Activity23 extends TabActivity{
	private String[] names = new String []
			{"中药便血肛裂治痔疮膏特效","芷晶草纯中药痔疮膏 ","纯中药华佗痔疮","痔疮纯中药痔疮痔核  "};
	private String[] descs = new String[]
			{"参考价格：¥38.0","参考价格：¥6.8","参考价格：¥16.0","参考价格：¥9.8"};
	private  int[] imageIds = new int[]
			{ R.drawable.zhichuang1,  R.drawable.zhichuang2,  R.drawable.zhichuang3,  R.drawable.zhichuang4};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_zhichuang);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_zhichuang_items);
//        为ListView设置Adapter
