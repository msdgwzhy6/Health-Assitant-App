...
public class PiYan_Activity34 extends TabActivity{
	private String[] names = new String []
			{"进口蓝顶喷雾剂 银屑神经性皮炎手足癣","脂溢性皮炎面部头皮特效神经性皮炎","绿力神农百草膏去牛皮癣湿疹皮炎","皮炎湿疹止痒脚气药膏"};
	private String[] descs = new String[]
			{"参考价格：¥298.0","参考价格：¥58.0","参考价格：¥48.0","参考价格：¥12.8"};
	private  int[] imageIds = new int[]
			{ R.drawable.piyan1,  R.drawable.piyan2,  R.drawable.piyan3,  R.drawable.piyan4};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_piyan);
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_piyan_items);
//        为ListView设置Adapter
