...
public class XiaoChuan_Activity10 extends TabActivity {
	private String[] names = new String []
			{"A级正宗化州橘红化橘红果陈果王切片 ","陈年化州橘红果花干久哮喘克星","仲景人咳喘舒康胶囊瓶装","化橘红花 正宗化橘红花茶 "};
	private String[] descs = new String[]
			{"参考价格：¥15.7","参考价格：¥59.0","参考价格：¥36.0","参考价格：¥32.0"};
	private  int[] imageIds = new int[]
			{ R.drawable.xiaochaun1,  R.drawable.xiaochan2,  R.drawable.xiaochuan3,  R.drawable.xiaochuan4};
	@Override
...
//        创建一个simpleAdapter
        ...
        ListView list = (ListView) findViewById(R.id.lv_xiaochuan_items);
//        为ListView设置Adapter
