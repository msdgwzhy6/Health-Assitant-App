...
public class basemap_Activity extends MapActivity{
	//添加百度地图的相关控件  
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        bMapManager = new BMapManager(basemap_Activity.this);  
        //调用百度地图加载KEY  
        bMapManager.init(key, new MKGeneralListener() {
			...
			public void onGetPermissionState(int arg0) {
				// TODO Auto-generated method stub
				 if(arg0 == 300){  
	                    Toast.makeText(basemap_Activity.this, "您输入的KEY有问题,请核实", 2).show();  
	                }  
        ...
        yaodian.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(basemap_Activity.this, Yaodian_Activity.class);
				startActivity(intent);
				//添加地图提示信息
				Toast toast = Toast.makeText(basemap_Activity.this,"滑动地图显示附近2000米内所有医院位置，点击显示具体药店名称",Toast.LENGTH_LONG);
				toast.show();
			}
		});
        ...
        yiyuan.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(basemap_Activity.this, Yiyuan_Activity.class);
				startActivity(intent);
				//添加地图提示信息
				Toast toast = Toast.makeText(basemap_Activity.this,"滑动地图显示附近2000米内所有医院位置，点击显示具体药店名称",Toast.LENGTH_LONG);
				toast.show();
        ...
        mLocationListener = new LocationListener() {
			...
			public void onLocationChanged(Location arg0) {
				...
				if(arg0!=null){
					...
					//执行搜索
					//mMKSearch.poiSearchNearBy("地铁", geoPoint, 2000);
	...
	public class MySearchListener implements MKGeneralListener, MKSearchListener {
		...
		public void onGetPoiResult(MKPoiResult arg0, int arg1, int arg2) {
			...
			PoiOverlay poioverlay = new PoiOverlay(basemap_Activity.this, mapView);
			// 设置搜索到的POI数据
